...
//       name: "Home",
//       path: "/userdashboard",
//       icon: <HousePlus className="w-5 h-5 text-blue-300" />,
//     },
//     {
//       name: "Users",
//       path: "/userlist",
...
//       icon: <LayoutGrid  className="w-5 h-5 text-red-300" />,
//     }
//   ];
...
//           <li
//             key={item.path}
//             className={`flex items-center gap-2 p-3 rounded-lg cursor-pointer transition duration-300 ${activePage === item.path
